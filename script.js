...
const motionFrames = {
  ...
  heading: [{ opacity: .4 }, { opacity: 1 }],
  product: [{ opacity: .5, transform: 'translateY(16px) scale(.98)' }, { opacity: 1, transform: 'translateY(0) scale(1)' }],
  review: [{ opacity: .5, transform: 'translateX(12px)' }, { opacity: 1, transform: 'translateX(0)' }],
  invitation: [{ opacity: .6, transform: 'scale(.98)' }, { opacity: 1, transform: 'scale(1)' }],
